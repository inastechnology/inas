...
WORK_METHOD_GUIDANCE.update(
    {
        ...
        "pest-observation": {
            ...
            "procedure_steps": ["問題が出やすい部位を確認する", "虫体、卵、食害、病斑の有無と範囲を記録する", "同定できない場合は写真を残して薬剤処理を保留する"],
        ...
        "hand-pollination": {
            ...
            "procedure_steps": ["対象品種と花粉親の適合性、開花段階を確認する", "乾いた花から花粉を採り、対象花へ付着させる", "処理した花または花房と日時を記録する"],
        ...
        "harvest": {
            ...
            "procedure_steps": ["収穫基準と前回の成熟状態を確認する", "病害虫や傷みを分けながら適熟のものだけを収穫する", "収穫量、品質、残した未熟果を記録する"],
        ...
        "repot": {
            ...
            "procedure_steps": ["植え替え適期、根鉢、用土、次の鉢サイズを確認する", "傷んだ根を必要最小限だけ整理して植え付ける", "十分に潅水し、置き場所と確認日を記録する"],
