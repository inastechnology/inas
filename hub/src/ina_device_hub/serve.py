...
from ina_device_hub.soil_moisture_notification_task import soil_moisture_notification_task
...
def run():
    ...
    hierarchy_service().attach_mqtt_client(hub_mqtt_client)
