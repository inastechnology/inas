(() => {
  ...
  const english = new Map(Object.entries({
    ...
    "灌水モード": "Irrigation mode",
    "通常灌水": "Continuous irrigation",
    "分割灌水": "Pulse irrigation",
    "予約ごとに設定した時間、続けて水を出します。": "Run water continuously for the duration set in each schedule.",
    "水を出す・止める動きを繰り返し、ゆっくり浸透させます。": "Alternate watering and pauses to let water soak in gradually.",
    "選んだモードは、この機器のすべての灌水予約に適用されます。": "The selected mode applies to every irrigation schedule on this device.",
    ...
    "繰り返し回数": "Repeat count",
    "水を出す合計": "Total watering",
    "予約開始から終了まで": "From schedule start to finish",
