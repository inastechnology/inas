...
- [jp/hub_mqtt_client.md](jp/hub_mqtt_client.md)
...
This file describes the hub module or component named `hub_mqtt_client`. Use it to record purpose, public APIs, dependencies, operational notes, and test expectations.
