...
- [jp/camera_connector.md](jp/camera_connector.md)
...
This file describes the hub module or component named `camera_connector`. Use it to record purpose, public APIs, dependencies, operational notes, and test expectations.
