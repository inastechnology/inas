...
- [jp/account_setup.md](jp/account_setup.md)
...
This file describes the hub module or component named `account_setup`. Use it to record purpose, public APIs, dependencies, operational notes, and test expectations.
