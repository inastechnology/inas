...
- [jp/tank_pump_manual.md](jp/tank_pump_manual.md)
...
This file describes the hub module or component named `tank_pump_manual`. Use it to record purpose, public APIs, dependencies, operational notes, and test expectations.
