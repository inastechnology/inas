...
- [jp/sensor_data_repository.md](jp/sensor_data_repository.md)
...
This file describes the hub module or component named `sensor_data_repository`. Use it to record purpose, public APIs, dependencies, operational notes, and test expectations.
