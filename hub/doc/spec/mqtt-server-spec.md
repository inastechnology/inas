...
- [jp/mqtt-server-spec.md](jp/mqtt-server-spec.md)
...
This file describes the hub module or component named `mqtt-server-spec`. Use it to record purpose, public APIs, dependencies, operational notes, and test expectations.
