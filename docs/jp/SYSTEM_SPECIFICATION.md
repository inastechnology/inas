...
INAS のミッションは、**世界からの呼びかけを、もう一度受け取れる社会をつくること**である。植物、土、水、天候などの変化を、人が現場で確かめ、どう応えるかを自ら選べる状態を目指す。

そのために INAS は、小規模な営農者が水やり、土壌状態、環境状態、作物前提、作業結果を一つの文脈で確認し、次のアクションを科学的に判断するためのシステムを提供する。センサー値や AI の提案は世界そのものや正解ではなく、現場へ注意を向ける手がかりとして扱う。製品判断の正典は [INAS エージェンティック農耕ビジョン](AGENTIC_AGRICULTURE_VISION.md) に定める。
