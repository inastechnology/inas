...
| `FUT-204` | Tursoを介したデバイス状態・設定・firmware targetのクラウド管理と、local Hubが監査付きで処理するcommand queue | 一部提供 | [Cloudflare Cloud App実装方針](../../hub/doc/jp/CLOUDFLARE_CLOUD_APP_IMPLEMENTATION.md) |
