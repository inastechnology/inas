...
| FUT-004 | Link field weather observations and forecast snapshots to sensors, work, growth, and yield for correlation research, accumulated-temperature features, explained advisories, and later approved schedule changes | specified | [field weather and cultivation research specification](../hub/doc/HUB_WEATHER_CULTIVATION_RESEARCH_SPEC.md) |
