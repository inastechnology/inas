...
| FUT-204 | Cloud management of device status, config, and firmware targets through Turso plus an audited command queue consumed by the local Hub | partial | [Cloudflare cloud app design](../hub/doc/jp/CLOUDFLARE_CLOUD_APP_IMPLEMENTATION.md) |
